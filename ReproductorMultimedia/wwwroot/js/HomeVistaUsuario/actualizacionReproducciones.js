$(document).ready(function () {
    ...
    $("audio").on("play", function () {
        ...
        //Con el evento timeupdate comprobamos cada segundo el tiempo de reproducción
        audio.addEventListener("timeupdate", function () {

            //Si ya se ha enviado la actualización no hace nada
            if (enviado) return;
            //Si el tiempo de reproducción es mayor o igual a 30 segundos cuenta como reproducción y se envía la actualización
            if (audio.currentTime >= 30) {
                ...
                enviado = true; //Para que no se envíe más de una vez
            }
        });
    });
});